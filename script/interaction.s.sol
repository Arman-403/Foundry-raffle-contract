...
contract AddConsumer is Script {
    ...
    function addConsumer(address mostRecentRaffleAdd, address vrfCoordinator, uint256 subId) public {
        vm.startBroadcast();
        VRFCoordinatorV2_5Mock(vrfCoordinator).addConsumer(subId, mostRecentRaffleAdd);
        vm.stopBroadcast();
    }
