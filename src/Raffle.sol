 ...
 * @author zk_lynx (Arman Sayyad)
 * @notice This contract is for creating a simple raffle
 * @dev Implementing Chainlink VRF v2 and Chainlink Keepers
 */
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    error Raffle__TransferFailed(address winner, uint256 balance);
        ...
        )
    {
        ...
        upkeepNeeded = enoughTimePassed && isRaffleOpen && hasBalance && hasPlayers;
    ...
    function fulfillRandomWords(
        ...
        override
    {
        //Checks (Pre-Conditions) - Checks written by myself for safety and to understood checks - arman sayyad
